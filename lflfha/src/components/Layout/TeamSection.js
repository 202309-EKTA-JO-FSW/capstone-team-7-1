...
const TeamSection = () => {
  const teamMembers = [
    ...
    },
    {
      name: 'Ammar Kolko',
      role: 'Full-Stack Developer',
      image: 'https://avatars.githubusercontent.com/u/82543366?v=4',
      linkedin: 'linkedin.com/in/ammar-kolko-39755674',
  ...
  return (
    <div >
      ...
      <h2 className="bg-orange decoration-orange font-bold text-center mb-20 text-orange-700 "> 4 People</h2>
