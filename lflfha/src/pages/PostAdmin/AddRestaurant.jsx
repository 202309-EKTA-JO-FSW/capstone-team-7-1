      ...
      <div>
        ...
        <form onSubmit={handleSubmit} className="mx-5 my-5">
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className=" border-2 border-yellow-500 font-bold text-white ml-3 py-2 px-20 rounded-2xl bg-orange-600 hover:bg-yellow-600"
            >
              Add Restaurant
            </button>
          </div>
        ...
        <form onSubmit={handleModify} className="mx-5 my-5">
          ...
          <div className="m-3 font-bold ">
            ...
            <input
              type="text"
              className="ml-2 rounded-md border-2 border-orange-700 border-dashed"
              value={modifiedData.restaurantAddress}
              onChange={handleModifiedChange}
            />
          </div>
          <div className="m-3 font-bold ">
            ...
            <input
              ...
              name="openingHours"
              className="ml-2 rounded-md border-2 border-orange-700 border-dashed"
              value={modifiedData.openingHours}
              onChange={handleModifiedChange}
            />
          </div>
          <div className="m-3 font-bold ">
          ...
          <div className="m-3 font-bold ">
            ...
            <input
              ...
              name="cuisineType"
              className="ml-2 rounded-md border-2 border-orange-700 border-dashed"
              value={modifiedData.cuisineType}
              onChange={handleModifiedChange}
            />
          </div>
          <div className="m-3 font-bold ">
