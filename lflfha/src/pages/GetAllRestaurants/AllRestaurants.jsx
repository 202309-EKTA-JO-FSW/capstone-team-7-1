...
function AllRestaurants() {
  ...
  return (
    <div className="restaurant flex flex-col flex-wrap ">
      {/* Header Page */}
      <div className="restaurant-header lg:min-h-[70vh] sm:min-h-[30vh] md:min-h-[40vh] min-h-[20vh] w-full flex flex-col justify-center items-center">
        <div className=" text-shadow-lg shadow-white lg:text-8xl md:text-7xl sm:text-5xl text-3xl flex justify-center flex-col items-center text-black opacity-100 font-bold  ">
