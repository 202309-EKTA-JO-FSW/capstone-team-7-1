      ...
      <div className="flex flex-wrap justify-center items-center -mx-4  ">
        ...
        <div className="px-4 flex-2 ">
          ...
          <p className="text-secondary text-lg text-center mb-10 p-8">
            ...
            from Re:coded Bootcamp, this web application takes you on a journey
            through a virtual bazaar, rich in flavors and culture. Leveraging
            dynamic JavaScript frameworks, we've created an engaging,
            user-friendly experience that not only demonstrates our technical
            prowess but also our dedication to creating memorable moments for
            our users.
          </p>
        </div>
      </div>
