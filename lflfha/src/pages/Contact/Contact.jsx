...
const ContactPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div
        className="bg-cover bg-center flex items-center justify-center text-4xl text-white font-bold mb-5 shadow-xl shadow-black	 "
        style={{ backgroundImage: "url('/1.png')", height: "350px" }}
      ></div>

      <h6 className="text-2xl  items-center text-orange-700 flex-grow flex  justify-center p-8 ">
        SEND US A MESSAGE
      </h6>
      ...
      <div className=" max-w-10xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-20 py-20   ">
        <div>
        ...
        <div>
          <h3 className="text-lg font-semibold text-orange-600 mb-2 hover:underline ">
            Call Us
          </h3>
